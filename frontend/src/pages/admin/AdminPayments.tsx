  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
        {[
          ...
          <div key={card.title} className="bg-card border border-border rounded-3xl p-6 flex gap-4 items-start hover:shadow-md transition-shadow opacity-60">
            <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#DBF2FF_50%,#D1EDFF_100%)] flex items-center justify-center">
              <span style={{ color: "#3D3C38" }}><card.icon size={24} /></span>
            </div>
            <div>
      ...
      <div className="bg-card border border-border rounded-3xl p-10 flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
        <div className="w-16 h-16 rounded-2xl bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#DBF2FF_50%,#D1EDFF_100%)] flex items-center justify-center mb-4">
          <span style={{ color: "#3D3C38" }}><CreditCard size={32} /></span>
        </div>
