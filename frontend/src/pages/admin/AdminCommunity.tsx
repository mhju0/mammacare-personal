        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              text-primary-foreground bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#C7E9FF_100%)] 
              hover:bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#B8E2FF_100%)] shadow-sm transition-all duration-300"
            >
                          ...
                          {inq.status === "pending" && (
                            <div className="flex justify-end">
                              <button
                                ...
                                className="flex items-center gap-1.5 px-4 py-2 rounded-3xl text-sm font-bold text-primary-foreground bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#C7E9FF_100%)] hover:bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#B8E2FF_100%)] shadow-sm transition-all duration-300"
                              >
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center pt-18 justify-center p-4" onClick={() => setShowNoticeModal(false)}>
          <div className="bg-card rounded-3xl w-full max-w-2xl shadow-2xl border border-border overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-4 border-t border-border flex gap-2">
              ...
              <button onClick={handleCreateNotice} className="flex-1 py-2.5 rounded-3xl font-bold text-primary-foreground bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#C7E9FF_100%)] hover:bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#B8E2FF_100%)] shadow-sm transition-all duration-300">공지 등록</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setEditingNotice(null)}>
          <div className="bg-card rounded-3xl w-full max-w-2xl shadow-2xl border border-border overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-4 border-t border-border flex gap-2">
              ...
              <button onClick={handleUpdateNotice} className="flex-1 py-2.5 rounded-3xl font-bold text-primary-foreground bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#C7E9FF_100%)] hover:bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#B8E2FF_100%)] shadow-sm transition-all duration-300">수정 완료</button>
            </div>
          </div>
        </div>
      )}
