    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          ...
          <div className="px-6 pb-5 border-t border-border pt-4 space-y-3">
            ...
            <form onSubmit={handleSearch} className="flex gap-3">
              ...
              <button
                type="submit"
                disabled={searching}
                className="px-4 py-2.5 rounded-xl bg-[radial-gradient(ellipse_at_center,#FFFAF0_0%,#FEF5CC_50%,#FFEFAB_100%)] text-primary-foreground border border-primary/50 shadow-sm text-sm font-medium hover:opacity-90 disabled:opacity-50 transition-opacity"
              >
                검색
              </button>
            </form>
                ...
                {searchResults.map((u) => (
                  <div key={u.id} className="px-5 py-4 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#C7E9FF_100%)] text-blue-600 text-xs font-medium hover:bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#B8E2FF_100%)] transition-colors"
                    >
      ...
      {modal && (
        <ConfirmModal
          ...
          confirmClass={
            modal.action === "grant"
              ? "text-primary-foreground font-bold bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#C7E9FF_100%)] hover:bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#B8E2FF_100%)] shadow-sm transition-all duration-300"
