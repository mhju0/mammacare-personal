...
const features = [
  {
    ...
    bgClass: "bg-[radial-gradient(ellipse_at_center,#EBF7FF_0%,#DBF2FF_50%,#D1EDFF_100%)]",
    title: "이유식 일정 관리",
    desc: isApp
          ...
          <div className="max-w-3xl mx-auto space-y-9 text-center">
            ...
            >
              ...
              <span
                ...
                style={{ fontFamily: "'Paperlogic'", fontWeight: 500, color: "#3D3C38" }}
              >
        ...
        <div className="max-w-4xl mx-auto px-5 py-8 grid grid-cols-3 gap-4 text-center">
          {[
            ...
            <div key={item.label} className="space-y-0.5">
              <div className="text-[#BAE4FF]">{item.icon}</div>
          ...
          {features.map((f) => (
            ...
            >
              <div className={`flex-shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center ${f.bgClass}`}>
                <span style={{ color: "#3D3C38" }}>{f.icon}</span>
              </div>
              <div>
                ...
                <div className={`bg-card border border-border rounded-3xl h-full ${isApp ? "p-4 space-y-2" : "p-6 space-y-3"}`}>
                  {isApp ? (
                    <div className="flex items-center gap-2">
                      <span className="font-black text-xl flex-shrink-0" style={{ color: "#BAE4FF" }}>
                        {s.num}
                      </span>
                    ...
                    <>
                      <span className="font-black text-3xl" style={{ color: "#BAE4FF" }}>
                        {s.num}
                      </span>
