    ...
    <div className="pointer-events-none absolute inset-0">
      ...
      {items.map((a, i) =>
        a.type === "callout" ? (
          <div
            key={`dot-${i}`}
            className="absolute h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#445769]"
      ...
      {items.map((a, i) => {
        ...
        return (
          <div
            ...
            whitespace-nowrap rounded-full bg-[#445769] px-4 py-1.5 text-base font-medium text-white shadow-lg"
...
export default function TutorialModal({
  ...
  return (
    ...
    >
      ...
      <div
        className="flex max-h-[80vh] w-full max-w-3xl flex-col overflow-hidden rounded-3xl bg-[#fffdf7] shadow-2xl ring-1 ring-black/5"
