...
import { Check, Clock, AlertTriangle, type LucideIcon } from "lucide-react";

import type { TestStatus } from "../../api/allergy";
import { cn } from "./utils";

export type ChipStatus = "safe" | "testing" | "reaction";
 ...
 */
export function StatusChip({ status, showLabel = true, className, ...props }: StatusChipProps) {
